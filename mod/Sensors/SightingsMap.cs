...
// The eye's short-term buffer of entities, ground items and watched blocks
// it has seen, or living entities it could plausibly hear. Not memory: a
// snapshot returns what was confirmed within the last moment, and Node
...
public sealed class SightingsMap(long ttlMs = 60000)
{
    ...
    // Entities are confirmed every tick; a watched block only when its column
    ...
    public object[] Snapshot(long now) => Current(now)
