...
public sealed partial class AiBridgeMod
{
    ...
    private object Observe()
    {
        ...
        return new
        {
            ...
            presentation = ClientPresentation.Observe(api),
