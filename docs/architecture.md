...
- `observe.nearbyEntities`: up to 24 living non-item entities in the loaded eight-block client neighborhood, sorted by distance. Node applies an explicit hostile code allowlist; unknown/modded entities are never treated as hostile by inference.
