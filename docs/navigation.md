...
- All live on the game client for the controller's lifetime; the controller's eye loop refreshes them every 250 ms whether or not a goal is running, and near-field terrain resets with the mod session.
