...
- After three consecutive stationary route failures, travel or food recovery (including food search before a lead is visible) may hand-break one body-level, native-reachable leaf block closest to the intended heading, then remap. This escape hatch requires cached server build/break permission and an empty hotbar slot; it never selects logs, ground, unknown blocks or out-of-reach foliage.
