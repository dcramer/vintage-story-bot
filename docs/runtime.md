...
- `forage`: ripe berries or allowlisted safe mushrooms → empty-hand harvest → fresh-food equip/eat → satiety/reserve verification. Berries use normal right-click; mushrooms use normal block breaking. `eat`: one verified consumption from inventory. Unknown, poisonous, psychedelic or spoiling food is refused; no raw meat. Food in backpack needs a free ordinary hotbar slot.
