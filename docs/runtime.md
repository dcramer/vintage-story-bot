...
- Travel advances through at most 48-block observed legs. A stationary direct attempt to a nearby destination switches to the same deterministic frontier search, so a local tree line, ridge or cliff cannot cause identical retries forever. Failed frontiers rotate through forward and lateral headings, while bounded visit penalties remain cheaper than a 180-degree reversal; productive partial legs continue from their newly observed frontier before another heading is selected.
