...
Check(SceneGeometry.Overlaps(new(0, 0, 0), new(1, 1, 1), new(.2, .35, .2), new(.8, 1.8, .8)), "body intersects full block");
Check(!SceneGeometry.Overlaps(new(0, 0, 0), new(1, .125, 1), new(.2, .475, .2), new(.8, 1.925, .8)), "thin snow is below body");
Check(!SceneGeometry.Overlaps(new(0, -1, 0), new(1, 0, 1), new(.2, .35, .2), new(.8, 1.8, .8)), "footing is below body");
