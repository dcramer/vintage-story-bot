import { horizontal, lookAt } from '../runtime/navigation/terrain.mjs';
    ...
    try {
      for (let n = 0; n < limit; n++) {
        ...
        try {
          ...
          if (object.kind === 'item') ok = (await (await import('../goals/collect_item.mjs')).collectItem(field, { target: object.key, expectedItem: object.code, radius: gleanRadius })).ok;
