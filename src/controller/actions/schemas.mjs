...
export const blockTarget = z.string().max(160).regex(/^block:0:-?\d+:-?\d+:-?\d+:[a-z0-9_-]+:[a-z0-9_./-]+$/)
...
export const blockPoint = z.object({ x: z.number().finite(), y: z.number().finite(), z: z.number().finite() }).strict()
