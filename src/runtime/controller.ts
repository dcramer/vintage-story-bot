...
export class Controller {
  eyeTimer: any; game: any; knowledge: any; send: any; telemetry: any;
  ...
  io(request: object, signal?: AbortSignal) { return this.game.io(request, signal); }
  ...
  launch(kind, args, work, by = 'operator') {
    ...
    const record: any = { id: randomUUID(), kind, args, by, state: 'starting', startedAt: Date.now(), abort,
